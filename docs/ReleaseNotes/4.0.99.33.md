---
permalink: /4.0.99.33.html
title: Release Notes - version 4.0.99.33
...
## Version 4.0.99.33-prerelease `<eengie and TheNamedOyster meets Kerbalism>` edition
...
<b>For best results - DO A CLEAN INSTALL; DELETE EXISTING INSTALLATION THEN RE-INSTALL</b></h4><p>Download from <a href="https://www.curseforge.com/kerbal/ksp-mods/SimpleConstrution/files">CurseForge</a></p></div>
...
* Issues
  * closes #166 - SimpleConstruction! (SCON) 4.0.99.33-prerelease `<TheNamedOyster>` edition
  * closes #167 - 4.0.99.33 Verify Legal Mumbo Jumbo
  * closes #168 - 4.0.99.33 Update Documentation
  * closes #169 - 4.0.99.33 Update Social Media
...
#### [Extraplanetary Launchpads (XPL)](https://github.com/taniwha/Extraplanetary-Launchpads)
...
[MOD:forum]: https://forum.kerbalspaceprogram.com/index.php?/topic/191424-*/ "SimpleConstruction! (SCON) forum thread"
[MOD:issue]: https://github.com/zer0Kerbal/SimpleConstruction/issues/ "Issue Tracker"
...
[MOD:works]: https://zer0kerbal.github.io/SimpleConstruction/HowItWorks "How It Works"

[MOD:shd:stat]: https://img.shields.io/badge/SimpleConstruction!%20(SCON)-4.0.99.33--prerelease-BADA55.svg?style=plastic&labelColor=darkgreen "4.0.99.33-prerelease"
